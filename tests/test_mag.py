...
def test_fun():
    for ts in tss:
        ...
        for method in methods:
            ...
            np.testing.assert_array_almost_equal(mag, analytic, err_msg="Function test failed for method: "+method + " and ts: "+ str(ts))
...
def test_weights():
    ...
    for ts in tss:
        for method in methods:
            ...
            np.testing.assert_array_almost_equal(mag, weights, err_msg="Weight test failed for method: "+ method + " and ts: "+ str(ts))
